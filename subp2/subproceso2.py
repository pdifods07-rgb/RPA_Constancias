from services.bd_service import obtener_ofertas_desde_bd, ejecutar_updates, ejecutar_query_masiva, insertar_registros
    ...
    try:
        ...
        for oferta, grupo in registros_1:
            ...
            if valido == 0: # solo valido
                insertar_registros(queries.QUERY_INSERT_SUBP2_COMPLETADO, oferta, grupo)
            else:
                insertar_registros(queries.QUERY_INSERT_SUBP2_ERROR, oferta, grupo)
